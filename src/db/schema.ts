import { pgSchema, pgTable, uuid, text, integer, bigint, varchar, timestamp, pgEnum, bigserial, json, jsonb, customType, numeric, boolean, inet, smallint, index, uniqueIndex, foreignKey, primaryKey, unique, check, pgPolicy, doublePrecision } from "drizzle-orm/pg-core"
...
export const dishes = pgTable("dishes", {
	...
	stockCount: smallint("stock_count").notNull(),
	imageUrl: text("image_url"),
	createdAt: timestamp("created_at", { withTimezone: true }).default(sql`now()`).notNull(),
