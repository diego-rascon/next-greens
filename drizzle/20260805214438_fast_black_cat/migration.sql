...
ALTER TABLE "dishes" ADD CONSTRAINT "dishes_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "categories"("id");--> statement-breakpoint
...
CREATE POLICY "Enable read access for all users" ON "dishes" AS PERMISSIVE FOR SELECT TO public USING (true);
*/